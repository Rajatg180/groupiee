...
class _GroupInfoState extends State<GroupInfo> {
  ...
  getImagUrl() async {
    await HelperFunctions.getUserProfileFromSF().then((value) {
      setState(() {
        profileUrl = value!;
      });
    });
  ...
  String getGrpName(String r) {
    List<String> parts = r.split("_");
  ...
  String getProfileUrl(String r) {
    List<String> parts = r.split("_");

    String desiredSubstring = parts[2].trim();
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                        ...
                        backgroundImage: NetworkImage(
                            getProfileUrl(snapshot.data['members'][index])),
                      ),
                      title: Text(getGrpName(snapshot.data['members'][index]),style: TextStyle(fontSize: 20),),
