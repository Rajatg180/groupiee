...
import 'package:groupieee/pages/profile_page.dart';
import 'package:groupieee/pages/search_page.dart';
import 'package:groupieee/services/auth_services.dart';
import 'package:groupieee/services/database_service.dart';
import 'package:groupieee/widget/group_tile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  gettingUserData() async {
    ...
    await HelperFunctions.getUserProfileFromSF().then((val) {
      setState(() {
        profileUrl = val!;
      });
    });
                  ...
                  onPressed: () async {
                    if (groupName != "") {
                      ...
                      DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid)
                          .createGroup(userName,FirebaseAuth.instance.currentUser!.uid, groupName,profileUrl)
                          .whenComplete(() {
                        _isLoading = false;
                      });
                      Navigator.of(context).pop();
